...
public class MainBroker {
    ...
    public static void main(String[] args) {
        ...
        orquestador.getDirectorio().registrarConexion(new Conexion("1", "127.0.0.1", 5002));
        orquestador.getDirectorio().registrarConexion(new Conexion("2", "127.0.0.1", 5003));
        orquestador.getDirectorio().registrarConexion(new Conexion("3", "127.0.0.1", 5004));
        orquestador.getDirectorio().registrarConexion(new Conexion("4", "127.0.0.1", 5005));
