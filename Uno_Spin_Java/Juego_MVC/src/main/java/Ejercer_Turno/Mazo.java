...
public class Mazo implements IMazoReadOnly {
    private final List<Carta> baraja;
    private final List<IMazoObserver> observers = new ArrayList<>();
    ...
    public void addObserver(IMazoObserver obs) { observers.add(obs); }
    
    private void notificar() {
        for (IMazoObserver obs : observers) obs.mazoActualizado();
    }

    @Override public int getCantidadCartas() { return baraja.size(); }
    @Override public boolean estaVacio() { return baraja.isEmpty(); }
