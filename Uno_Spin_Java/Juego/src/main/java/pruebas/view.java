...
public class view extends javax.swing.JFrame {
     ...
     */
    public view() {
        Carta carta = new Carta("cero",Color.ORANGE,"rojo", "/cartas/cero.png","/cartas/atras.png");
        panelCarta = new PanelCarta(carta);
        setContentPane(panelCarta);
        setSize(800,600);
