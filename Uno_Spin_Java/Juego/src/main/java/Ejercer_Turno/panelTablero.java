...
public class PanelTablero extends JPanel{
    ...
    public PanelTablero(Jugador jugador1,Jugador jugador2,Jugador jugador3,Jugador jugador4,int rangoInicio, int rangoFinal,boolean masDos, boolean prohibido, boolean reversa, boolean masCuatro, boolean cambioColor,Color cambioAzul, Color cambioRojo, Color cambioAmarillo, Color cambioVerde, Color cambioNegro, int numCartas) {
        ...
        setLayout(null);
        mazo = new Mazo(rangoInicio, rangoFinal,masDos,prohibido,reversa,masCuatro,cambioColor, cambioAzul, cambioRojo, cambioAmarillo,cambioVerde, cambioNegro);
        ...
        add(panelMano1);
        this.panelMano2 = new PanelManoSecundaria(mazo.tomarCartas(numCartas),panelDescarte,panelJugador2,"izquierda");
        this.panelMano2.setBounds(0,100,120,500);
        add(panelMano2);
        this.panelMano3 = new PanelManoSecundaria(mazo.tomarCartas(numCartas),panelDescarte,panelJugador3,"arriba");
        this.panelMano3.setBounds(350,0,500,120);
        add(panelMano3);
        this.panelMano4 = new PanelManoSecundaria(mazo.tomarCartas(numCartas),panelDescarte,panelJugador4,"derecha");
